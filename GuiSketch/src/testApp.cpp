...
void testApp::setup()
{
  ...
  box1Button.addListener(this,&testApp::boxOnButton);
  box2Button.addListener(this,&testApp::boxOffButton);

  controlPanel.setup();
  controlPanel.add(rowSlider.setup("Rij",0,0,7,300,20));
  controlPanel.add(columnSlider.setup("Kolom",0,0,15,300,20 ));
  controlPanel.add(box1Button.setup("Switch box on"));
  controlPanel.add(box2Button.setup("Switch box off"));
...
void testApp::exit1()
{
  box1Button.removeListener(this,&testApp::boxOnButton);
} // exit()

void testApp::exit2()
{
  box2Button.removeListener(this,&testApp::boxOffButton);
}
